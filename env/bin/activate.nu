...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/prashant/my_projects/Django-REST-Framework-User-Registration-Authentication/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/prashant/my_projects/Django-REST-Framework-User-Registration-Authentication/env/bin/deactivate.nu'
